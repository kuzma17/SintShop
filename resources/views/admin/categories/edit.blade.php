            ...
            <div class="tab-content mt-3" id="myTabContent">
                <div class="tab-pane fade show active" id="page" role="tabpanel">
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="name_ru" value="{{old('name_ru', $category->name_ru)}}" class="form-control @error('name_ru') is-invalid @enderror">
                            @error('name_ru')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="name_ua" value="{{old('name_ua', $category->name_ua)}}" class="form-control @error('name_ua') is-invalid @enderror">
                            @error('name_ua')
                            <span class="invalid-feedback" role="alert">
                       <strong>{{ $message }}</strong>
                   </span>
                ...
                <div class="tab-pane fade" id="seo" role="tabpanel">
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[meta_title_ru]" value="{{old('seo.meta_title_ru', $category->seo?->meta_title_ru)}}" class="form-control @error('meta_title_ru') is-invalid @enderror">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[meta_title_ua]" value="{{old('seo.meta_title_ua', $category->seo?->meta_title_ua)}}" class="form-control @error('meta_title_ua') is-invalid @enderror">
                    ...
                    <textarea name="seo[meta_description_ru]" class="form-control">
                        {{old('seo.meta_description_ru', $category->seo?->meta_description_ru)}}
                    </textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <textarea name="seo[meta_description_ua]" class="form-control">
                        {{old('seo.meta_description_ru', $category->seo?->meta_description_ua)}}
                    </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[meta_keywords_ru]" value="{{old('meta_keywords_ru', $category->seo?->meta_keywords_ru)}}" class="form-control @error('meta_keywords_ru') is-invalid @enderror">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[meta_keywords_ua]" value="{{old('meta_keywords_ua', $category->seo?->meta_keywords_ua)}}" class="form-control @error('meta_keywords_ua') is-invalid @enderror">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[og_title_ru]" value="{{old('og_title_ru', $category->seo?->og_title_ru)}}" class="form-control @error('og_title_ru') is-invalid @enderror">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" name="seo[og_title_ua]" value="{{old('og_title_ua', $category->seo?->og_title_ru)}}" class="form-control @error('og_title_ua') is-invalid @enderror">
                    ...
                    <textarea name="seo[og_description_ru]" class="form-control">
                        {{old('seo.description_ru', $category->seo?->og_description_ru)}}
                    </textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <textarea name="seo[og_description_ua]" class="form-control">
                        {{old('seo.description_ru', $category->seo?->og_description_ua)}}
                    </textarea>
                        </div>
                    </div>
